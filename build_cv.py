...
class BuildCV(object):
    ...
    def __init__(self, yaml_config_file, md_template='cv_template.md', tex_template='cv_template.tex',
        ...
        self.logger.info('Reading CV data from {}'.format(yaml_config_file))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--md_template", help="Markdown/HTML template", default='cv_template.md')
    parser.add_argument("--tex_template", help="TeX template", default='cv_template.tex')
    parser.add_argument("--md_out_file", help="where to write tex version of CV to",
                        default=os.path.join(cur_dir, 'output', 'cv.md'))
    parser.add_argument("--tex_out_file", help="where to write markdown version of CV to",
                        default=os.path.join(cur_dir, 'output', 'cv.tex'))
